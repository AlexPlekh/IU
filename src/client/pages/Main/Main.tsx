    ...
    <>
      ...
      <main className="bg-blue-300 flex flex-col items-center relative">
        <div className="my-40 p-10 bg-white rounded">
          ...
          {!isUserAdult && !userData.inFamilyGroup && <p className="text-center text-red-400">! Часть контента недоступна для несовершеннолеетних !</p>}
          <div className="flex mt-10 justify-evenly">
            {!userData.inFamilyGroup && <button
              type="button"
